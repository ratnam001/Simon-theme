	...
	public function getContent(){
		...
		if( Tools::isSubmit('submit') ){
			if (!sizeof($this->_postErrors)){
				...
				$html .= $this->displayError(implode('<br>', $this->_postErrors));				
			}
		...
		if(Tools::getValue('lofconf') == 1){
			$html .= $this->displayConfirmation($this->l('Delete Block successful.'));
		}elseif(Tools::getValue('lofconf') == 2){
			$html .= $this->displayError($this->l('Delete Block error'));
		}
		if (sizeof($this->_postErrors)){
			$html .= $this->displayError(implode('<br>', $this->_postErrors));				
		}
