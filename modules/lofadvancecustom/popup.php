	...
	<fieldset>
		...
		<form action="" method="post">
			...
			if(_PS_VERSION_ < "1.5"){
				...
				echo '<script type="text/javascript" src="'.__PS_BASE_URI__.'modules/lofadvancecustom/tinymce/tinymce.min.js"></script>';				
				...
				echo '
					<script type="text/javascript">	
						...
						tinyMCE.init({
							selector: "textarea" ,
							plugins : "preview link paste pagebreak image media table contextmenu table code autoresize textcolor filemanager",
							external_filemanager_path: ad+"/filemanager/",
							filemanager_title: "File manager" ,
							external_plugins: { "filemanager" : ad+"/filemanager/plugin.min.js"},
							toolbar1 : "preview,code,|,bold,italic,underline,strikethrough,|,alignleft,aligncenter,alignright,alignfull,formatselect,|,blockquote,pasteword,|,bullist,numlist,|,outdent,indent,|,link,unlink,|,cleanup,",
							toolbar2: "image,",
							statusbar: false,
							relative_urls : false,
							convert_urls: false,
							...
							menu: {
								...
								insert: {title: \'Insert\', items: \'link | image | pagebreak\'},
